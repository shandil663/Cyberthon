...
public class Firstadapter3 extends RecyclerView.Adapter<Firstadapter3.MyViewHolder> {
    Context context;
    ArrayList<helperforinsight> list;

    public Firstadapter3(Context context, ArrayList<helperforinsight> list) {
